...
struct CampaignResultEvidence<'a> {
    ...
    watchdog_read_outcome: &'a str,
    watchdog_owner_phase: &'a str,
    watchdog_owner_subphase: &'a str,
    watchdog_wait_state: &'a str,
...
pub(super) fn finish_campaign_attempt(
    ...
    let seal_result = (|| -> Result<()> {
        ...
        let evidence = CampaignResultEvidence {
            ...
            watchdog_read_outcome: attempt.network_evidence.watchdog_read_outcome,
            watchdog_owner_phase: attempt.network_evidence.watchdog_owner_phase,
            watchdog_owner_subphase: attempt.network_evidence.watchdog_owner_subphase,
            watchdog_wait_state: attempt.network_evidence.watchdog_wait_state,
