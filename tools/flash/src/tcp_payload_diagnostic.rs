...
const INTENT_RELATIVE_PATH: &str = "scratch/str005-tcp-payload/diagnostic-001/intent.private.json";
const POOL_RELATIVE_PATH: &str =
    "scratch/str005-tcp-payload/diagnostic-001/fixture-pool.private.json";
