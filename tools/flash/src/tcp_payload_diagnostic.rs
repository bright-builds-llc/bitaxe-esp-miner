...
const INTENT_RELATIVE_PATH: &str = "scratch/str005-tcp-payload/diagnostic-006/intent.private.json";
...
const DIAGNOSTIC_ORDINAL: u16 = 6;
...
mod tests {
    ...
    #[test]
    fn plan_digest_and_half_close_gated_sixth_ordinal_are_immutable() {
        // Arrange
        ...
        assert_eq!(DIAGNOSTIC_ORDINAL, 6);
        assert!(INTENT_RELATIVE_PATH.contains("diagnostic-006"));
    }
}
