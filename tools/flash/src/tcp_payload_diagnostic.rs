...
const INTENT_RELATIVE_PATH: &str = "scratch/str005-tcp-payload/diagnostic-007/intent.private.json";
const POOL_RELATIVE_PATH: &str =
    "scratch/str005-tcp-payload/diagnostic-007/fixture-pool.private.json";
...
const DIAGNOSTIC_ORDINAL: u16 = 7;
...
mod tests {
    ...
    #[test]
    fn plan_digest_and_shutdown_error_gated_seventh_ordinal_are_immutable() {
        // Arrange
        ...
        assert_eq!(DIAGNOSTIC_ORDINAL, 7);
        assert!(INTENT_RELATIVE_PATH.contains("diagnostic-007"));
    }
}
