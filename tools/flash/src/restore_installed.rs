...
pub(crate) const PREFLIGHT_ROOT: &str = "scratch/str005-exact-restoration/preflight-003";
pub(crate) const EFFECT_ROOT: &str = "scratch/str005-exact-restoration/remediation-003";
pub(crate) const CAMPAIGN_RESTORE_ROOT: &str = "scratch/str005-stratum-v2/attempt-006/restoration";
...
fn validate_common(
    ...
    if common.schema != RESTORE_SCHEMA
        ...
        || !matches!(
            ...
            ("preflight" | "start", 3) | ("campaign_restore", 6)
        )
