...
export async function scoreboardFixture(name: string): Promise<ScoreboardFixture> {
  ...
  const planRelative = "docs/parity/work-plans/20260818T090846Z-STAT-003/PLAN.md";
  ...
  const wrapper = path.join(root, "scratch/stat003-scoreboard/wrapper-002");
  ...
  return {
    ...
    options: {
      ...
      detectorOutput: "scratch/stat003-scoreboard/wrapper-002/detector.stdout",
