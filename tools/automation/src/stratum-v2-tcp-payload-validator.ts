...
const evaluatorSources = [
  ...
  "tools/automation/src/stratum-v2-tcp-finalize.ts",
  ...
  "tools/automation/src/stratum-v2-tcp-publish.ts",
  "tools/automation/src/stratum-v2-tcp-payload-validator.ts",
  "tools/automation/src/stratum-v2-tcp-payload-validator-cli.ts",
