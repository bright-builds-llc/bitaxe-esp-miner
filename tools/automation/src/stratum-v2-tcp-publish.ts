...
import type { JsonObject } from "./stratum-v2-tcp-connection.js";
...
export async function publishTcpPayloadProjection(
  workspace: string,
  privateRoot: string,
  ...
  const validated = await runProcess(
    ...
    [
      ...
      path.join(
        workspace,
        "bazel-bin/tools/automation/stratum_v2_tcp_payload_validator_/stratum_v2_tcp_payload_validator",
      ),
      privateCandidate,
      expectedSource,
