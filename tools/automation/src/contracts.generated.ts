...
export type ScoreboardEvidence = { schema_version: "bitaxe-scoreboard-evidence-v1"; board: 205; attempt_ordinal: 4; source_commit: string; reference_commit: string; package_manifest_sha256: string; workflow: WorkflowIdentity; source: ScoreboardSourceEvidence; scoreboard: ScoreboardObservationEvidence; detector_admitted: boolean; runtime_identity: "trusted"; campaign_profile: "conservative"; campaign_duration_seconds: 600; campaign_status: "accepted"; safe_stop_confirmed: boolean; cleanup_complete: boolean; hardware_rerun_used: false; private_modes_valid: boolean; redaction_status: "passed"; };
