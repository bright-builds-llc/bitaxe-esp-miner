...
export type AutomationCommand =
  ...
  | "project-safe10-evidence" | "project-cfg07-evidence"
...
export type ScoreboardEvidence = { schema_version: "bitaxe-scoreboard-evidence-v1"; board: 205; attempt_ordinal: 5; source_commit: string; reference_commit: string; package_manifest_sha256: string; workflow: WorkflowIdentity; source: ScoreboardSourceEvidence; scoreboard: ScoreboardObservationEvidence; detector_admitted: boolean; runtime_identity: "trusted"; campaign_profile: "conservative"; campaign_duration_seconds: 600; campaign_status: "accepted"; safe_stop_confirmed: boolean; cleanup_complete: boolean; hardware_rerun_used: false; private_modes_valid: boolean; redaction_status: "passed"; }; export type ScoreboardSourceEvidenceV2 = { capture_plan_sha256: string; capture_closure_sha256: string; evaluation_plan_sha256: string; campaign_result_sha256: string; campaign_network_sha256: string; campaign_diagnostics_sha256: string; protected_input_sha256: string; source_inventory_sha256: string; source_semantics_current: boolean; reference_semantics_current: boolean; source_path_count: number; }; export type ScoreboardEvidenceV2 = { schema_version: "bitaxe-scoreboard-evidence-v2"; board: 205; attempt_ordinal: 5; source_commit: string; evaluation_source_commit: string; reference_commit: string; capture_package_identity_sha256: string; capture_terminal_boundary: "old_verifier_restart_persistence_only"; workflow: WorkflowIdentity; source: ScoreboardSourceEvidenceV2; scoreboard: ScoreboardObservationEvidence; detector_admitted: boolean; runtime_identity: "trusted"; campaign_profile: "conservative"; campaign_duration_seconds: 600; campaign_status: "accepted"; safe_stop_confirmed: boolean; cleanup_complete: boolean; hardware_rerun_used: false; private_modes_valid: boolean; redaction_status: "passed"; };
export type Safe10SourceEvidence = { plan_sha256: string; attempt_plan_sha256: string; attempt_closure_sha256: string; campaign_result_sha256: string; campaign_network_sha256: string; campaign_observations_sha256: string; campaign_diagnostics_sha256: string; current_source_inventory_sha256: string; attempt_source_inventory_sha256: string; source_semantics_current: boolean; reference_semantics_current: boolean; attempt_source_compatible: boolean; source_path_count: number; production_path_count: number; reference_path_count: number; };
export type Safe10PrerequisiteEvidence = { power_watts_required: boolean; bus_voltage_required: boolean; current_required: boolean; chip_temperature_required: boolean; vr_temperature_required: boolean; fan_rpm_required: boolean; power_watts_fresh: boolean; bus_voltage_fresh: boolean; current_fresh: boolean; chip_temperature_fresh: boolean; vr_temperature_fresh: boolean; fan_rpm_fresh: boolean; fresh_observation_count: number; safety_fresh: boolean; readiness_unblocked: boolean; session_running_primary: boolean; hardware_ready: boolean; readiness_safety_fresh: boolean; observation_epoch_advanced: boolean; pending_observation_recovered: boolean; active_ms: number; required_window_count: number; covered_window_count: number; work_renewal_valid: boolean; active_state_valid: boolean; network_safety_valid: boolean; watchdog_valid: boolean; qualified_candidate_observed: boolean; accepted_submit_observed: boolean; terminal_http_valid: boolean; terminal_websocket_valid: boolean; terminal_pool_persisted: boolean; final_terminal_consumed: boolean; serial_finished_observed: boolean; };
export type Safe10Evidence = { schema_version: "bitaxe-safe10-evidence-v1" | "bitaxe-safe10-evidence-v2"; board: 205; attempt_ordinal: 3; attempt_source_commit: string; current_source_commit: string; reference_commit: string; workflow: WorkflowIdentity; source: Safe10SourceEvidence; prerequisites: Safe10PrerequisiteEvidence; detector_admitted: boolean; runtime_identity: "trusted"; campaign_stage: "live-share"; campaign_profile: "conservative"; campaign_status: "accepted"; network_status: "accepted"; safe_stop_confirmed: boolean; cleanup_complete: boolean; hardware_rerun_used: false; protected_modes_valid: boolean; redaction_status: "passed"; };
export type Cfg07SourceEvidence = { plan_sha256: string; attempt_plan_sha256: string; attempt_closure_sha256: string; safe10_projection_sha256: string; current_source_inventory_sha256: string; attempt_source_inventory_sha256: string; source_semantics_current: boolean; reference_semantics_current: boolean; attempt_source_compatible: boolean; source_path_count: number; production_path_count: number; reference_path_count: number; }; export type Cfg07CredentialEvidence = { runtime_credentials_input: "local-owner-supplied"; wifi_input_required: boolean; pool_input_required: boolean; inputs_forwarded_to_campaign: boolean; live_mining_credentials_consumed: boolean; accepted_submit_observed: boolean; committed_credential_values: "none"; raw_artifacts_committed: "no"; credential_contents_read_by_projector: false; }; export type Cfg07Evidence = { schema_version: "bitaxe-cfg07-evidence-v1"; board: 205; attempt_ordinal: 3; attempt_source_commit: string; current_source_commit: string; reference_commit: string; workflow: WorkflowIdentity; source: Cfg07SourceEvidence; credentials: Cfg07CredentialEvidence; detector_admitted: boolean; runtime_identity: "trusted"; campaign_stage: "live-share"; campaign_profile: "conservative"; campaign_status: "accepted"; network_status: "accepted"; safe_stop_status: "complete"; cleanup_complete: boolean; protected_modes_valid: boolean; redaction_status: "passed"; };
