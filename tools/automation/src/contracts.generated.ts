...
export type AdcObservationEvidence = { schema_version: "bitaxe-adc-observation-evidence-v1"; board: 205; attempt_ordinal: 3; source_commit: string; reference_commit: string; package_manifest_sha256: string; workflow: WorkflowIdentity; source: AdcObservationSourceEvidence; adc: AdcObservationQuorum; detector_admitted: true; boot_observed: true; mining_state: "disabled"; hardware_control_state: "disabled"; cleanup_complete: true; recovery_used: false; redaction_status: "passed"; };
