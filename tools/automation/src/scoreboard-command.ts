import { captureScoreboardEvidence } from "./scoreboard-evidence.js";
...
export async function captureScoreboardEvidenceFromInvocation(
  root: string,
  ...
  return captureScoreboardEvidence(root, {
