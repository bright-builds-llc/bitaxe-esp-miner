...
impl UsbTerminalCategory {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::HandoffCommitTimeout => "handoff_commit_timeout",
            Self::BusResetTimeout => "bus_reset_timeout",
            Self::SameWorkerAfterCommit => "same_worker_after_commit",
            ...
            Self::RomAdmissionFailed => "rom_admission_failed",
            ...
            Self::UsbEnumerationLost => "usb_enumeration_lost",
