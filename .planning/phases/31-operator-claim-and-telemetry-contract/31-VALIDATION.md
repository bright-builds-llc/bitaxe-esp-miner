...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 31-01-01 | 01 | 1 | OBS-01 | T-31-01 | Invalid state/value combinations are unconstructible | unit | `cargo test -p bitaxe-safety --all-features observation` | ✅ | ⬜ pending |
| 31-01-02 | 01 | 1 | OBS-01 | T-31-02 | Failed/stale transitions cannot mint new sample metadata | unit | `cargo test -p bitaxe-safety --all-features observation` | ✅ | ⬜ pending |
| 31-02-01 | 02 | 2 | OBS-01 | T-31-03 | Compatibility zero never authenticates freshness | unit/golden | `cargo test -p bitaxe-api --all-features safety_telemetry` | ✅ | ⬜ pending |
| 31-02-02 | 02 | 2 | OBS-01 | Consumer reads cannot advance producer-owned stamps | regression | `cargo test -p bitaxe-api --all-features projection` | ✅ | ⬜ pending |
| 31-03-01 | 03 | 3 | CFG-08 | T-31-04 | Only validated hostname can construct v1.2 write authority | unit | `cargo test -p bitaxe-api --all-features settings` | ✅ | ⬜ pending |
