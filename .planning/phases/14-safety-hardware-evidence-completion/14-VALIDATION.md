...
| 14-06-03 | 06 | 5 | SAFE-08, EVD-05 | T-14-05 | Final verification runs all shell, Bazel, Cargo, parity, reference, diff, and lifecycle gates before phase completion. | workflow | `just parity && just verify-reference && node /Users/peterryszkiewicz/.codex/get-shit-done/bin/gsd-tools.cjs verify lifecycle 14 --expect-id 14-2026-06-30T23-56-34 --expect-mode yolo --require-plans --raw` | yes | pending |
