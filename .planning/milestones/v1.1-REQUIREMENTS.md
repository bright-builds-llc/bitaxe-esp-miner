# Requirements Archive: v1.1 Ultra 205 Trusted Production Mining

**Archived:** 2026-07-13
**Status:** SHIPPED WITH ACCEPTED GAPS
**Outcome:** 18/21 requirements satisfied; STR-09, ASIC-11, and CFG-07 accepted as unresolved

Fresh requirements will be created by `/gsd-new-milestone`; there is no active requirements file after this archive closes.

***

## Outcome Notes

- **Validated:** 18 requirements have phase and milestone evidence sufficient for their recorded claims.
- **Accepted unresolved:** STR-09 lacks an eligible live ASIC-derived share response; ASIC-11 lacks a live correlated BM1366 result; CFG-07 lacks an eligible end-to-end live credential-handling evidence root.
- **Adjusted at closure:** Phase 30 completed as a conservative no-promotion decision. It did not satisfy the three pending requirements.
- **Dropped:** None.
- **Checkbox semantics:** Checked requirement definitions below record that each requirement was planned and implemented against. The Traceability table and this outcome section are authoritative for validation status; checked definitions do not convert pending requirements into verified claims.
...
*Last updated: 2026-07-13 after Phase 30 no-promotion closure and the v1.1 milestone audit*
