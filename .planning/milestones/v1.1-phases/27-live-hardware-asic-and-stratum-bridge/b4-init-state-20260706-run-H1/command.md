...
Repo-owned Phase 27 wrapper command only; raw Stratum, raw BM1366, unsafe hardware control, erase, rollback, stale targets, and network scans are not accepted.
