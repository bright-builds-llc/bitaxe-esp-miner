...
status: administratively_closed_with_gaps
stopped_at: Archived after 36-10-PLAN.md sealed_non_promotion; Plans 36-07 and 36-04 incomplete
last_updated: "2026-07-25T21:29:28Z"
...
Phase: 36 (substantive-evidence-admission-and-exact-re-promotion) — ARCHIVED WITH GAPS
Plan: 8 of 10

- **Phase:** 36 of 36 (substantive evidence admission and exact re-promotion)
- **Plan:** 8 of 10
- **Status:** Administratively closed with gaps; not released
...
- **Closure:** Plan 36-10 sealed non-promotional and produced no eligible
  candidate. Plans 36-07 and 36-04 did not complete. No `v1.2` release tag was
  created, and device restoration remains unresolved.

## Project Reference

See `.planning/milestones/v1.2-PROJECT.md` for the archived milestone context
and `TASKS.md` for current work. Core value remains observable device-user
parity on real Bitaxe hardware.
