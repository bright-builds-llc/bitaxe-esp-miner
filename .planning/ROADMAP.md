...
| 28.1.1.5. BM1366 Match Upstream Chip-Enumerate Before Init Nonce-Production Diagnosis | v1.1 | 0/4 | Planned | — |
...
Plans:
- [ ] 28.1.1.5-01-PLAN.md — Wave 0 chip-enumerate comparator + fixture tests (`forced_ab_label: count_asic_chips_rx_loop_parity`)
- [ ] 28.1.1.5-02-PLAN.md — RX-loop + counted-handoff patch + detector-gated ≥360s fake-pool A/B
