...
- [ ] 17-01-PLAN.md - Add Wave 0 helper tests, Bazel wiring, WebSocket capture helper, and evidence/redaction scaffold.
- [ ] 17-02-PLAN.md - Capture current package, release-gate, detector, and flash-monitor identity evidence.
...
| 17. Live HTTP API And Static Evidence | 0/5 | Pending | TBD |
