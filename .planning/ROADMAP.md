...
| 28.1. Live Mining Blocker Fix (H4/W13 + Probes) | v1.1 | 0/5 | Planned   | - |
...
Plans:
- [ ] 28.1-01-PLAN.md — Pure core: BridgeOrchestrator with J2c dispatch-priority regression tests, regenerate_work + extranonce2 counter, bm1366_job_interval_ms
- [ ] 28.1-02-PLAN.md — Firmware defaults: W13 unconditional post-init retention and bridge pump delegation to BridgeOrchestrator (timeout=continue, keep mining)
- [ ] 28.1-03-PLAN.md — Discriminating probes: post-init/post-dispatch register-read probe and INA260 power-delta marker with I2C bus retention
- [ ] 28.1-04-PLAN.md — Flag disposition: retire obsolete investigation modes, add single_dispatch_bounded_read control lever, fail-closed default proof
