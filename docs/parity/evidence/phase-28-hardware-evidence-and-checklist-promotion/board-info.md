...
source_slot: ../phase-27-live-hardware-asic-and-stratum-bridge/board-info.md
...
Phase 28 cross-links the Phase 27 board-info slot. Phase 27 recorded `board_info_status: passed` for ESP32-S3 before the bounded live capture attempt.

## conclusion

Consolidation preserves Phase 27 board-info category labels only.
