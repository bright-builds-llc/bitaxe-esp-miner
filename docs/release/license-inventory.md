...
| ESP-IDF Rust sys crate | `esp-idf-sys 0.37.2` at `f616563a87595032f06f1fec95b6816b1c11135c`                                                            | `docs/release/cargo-about.html` plus pinned upstream Git metadata | Cargo license covered; exact upstream pin is retained without a dependency upgrade; the active native Serial/JTAG path does not include TinyUSB. Native ESP-IDF remains reviewed separately. |
