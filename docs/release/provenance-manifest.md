...
| --- | --- | --- |
| `esp-miner.bin` | Source commit, reference commit, generation command, offset, SHA-256, ESP-IDF version, linked component notice review | Package manifest evidence recorded in docs/parity/evidence/phase-08-ultra-205-release-summary.md; GPL-risk-reviewed release artifact; publication waits for final release approval. |
| `www.bin` | Static source tree, generation command, size, SHA-256, static asset provenance review | Package manifest evidence recorded in docs/parity/evidence/phase-08-ultra-205-release-summary.md; GPL-risk-reviewed release artifact; publication waits for final release approval. |
| `otadata-initial.bin` | ESP-IDF generated `ota_data_initial.bin` when available, otherwise an 8192-byte erased flash image generated by the package script | Package manifest evidence recorded in docs/parity/evidence/phase-08-ultra-205-release-summary.md; GPL-risk-reviewed release artifact; publication waits for final release approval. |
| `bitaxe-ultra205-factory.bin` | Merge command, offsets, included artifacts, SHA-256, installation notes | Package manifest evidence recorded in docs/parity/evidence/phase-08-ultra-205-release-summary.md; GPL-risk-reviewed release artifact; publication waits for final release approval. |
| `bitaxe-ultra205-package.json` | Manifest v2 validation, artifact paths, checksums, tool versions, install notes, license/provenance links | Package manifest evidence recorded in docs/parity/evidence/phase-08-ultra-205-release-summary.md; GPL-risk-reviewed release artifact; publication waits for final release approval. |
