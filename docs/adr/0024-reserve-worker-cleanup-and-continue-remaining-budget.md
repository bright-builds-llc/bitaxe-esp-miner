# ADR-0024: Fence Worker reservation cleanup and qualify remaining windows

Accepted 2026-09-06 under the owner's authorization to complete admission
recovery, diagnostics and the subsequent live testing. This refines ADR-0021
and preserves ADR-0022's four cycles and ADR-0023's serial 0.2 transport.
