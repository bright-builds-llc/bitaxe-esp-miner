...
Migration dependency: `task-fixed-usb-serial-qualification` remains open: the [cadence preparation](docs/parity/evidence/20260913-cpu0-telemetry-cadence.md) passed four continuity cycles but failed idle-review admission before USB-load or mining measurements. [The reconciliation](docs/parity/evidence/20260913-usb-qualification-reconciliation.md) retains the separately satisfied continuity, live-stop and Hello-recovery obligations. Qualification replaces TinyUSB handoff/recovery-006 requirements. The immutable legacy plan is historical and requires a successor contract before effects. Independent authorization, replay, monotonicity, protocol and evidence blockers remain unresolved.
