...
- [x] Implement Gate Controller 0.4, serial 0.1, possession 0.2, signing/conformance and real browser/headless composition; remove obsolete active compatibility paths.
