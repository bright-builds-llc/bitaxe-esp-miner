...
- [ ] Implement and verify the missing idle authenticated Web Serial restart command and bounded expected-reset observation lifecycle before any restart effect.
- [ ] Publish software/contract before effects; detect one Ultra 205 and capture 120 seconds of fresh authenticated read-only health/boot observations with fresh unchanged accounting. No installation is authorized by this observation step.
