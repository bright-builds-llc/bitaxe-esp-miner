...
- [ ] Require clean synchronized pushed `7917de87`, opaque non-empty ignored
...
- [ ] Run `just package`; create protected `detector-036`; run exactly one
      `just detect-ultra205`; require its zero exit, private modes, and one
      admitted board-205 device.
- [ ] Create separate protected `wrapper-036`, keep `attempt-036` absent, and
