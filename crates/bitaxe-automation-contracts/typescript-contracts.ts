...
export type HashrateMonitorEvidence = { schema_version: "bitaxe-hashrate-monitor-evidence-v1"; board: 205; attempt_ordinal: 16; source_commit: string; reference_commit: string; package_manifest_sha256: string; workflow: WorkflowIdentity; source: HashrateMonitorSourceEvidence; hashrate: HashrateMonitorQuorum; detector_admitted: boolean; runtime_identity: "trusted"; campaign_profile: "conservative"; campaign_duration_seconds: 600; network_status: "accepted"; mining_state: "active_then_paused"; safe_stop_confirmed: boolean; cleanup_complete: boolean; hardware_rerun_used: false; redaction_status: "passed"; };
