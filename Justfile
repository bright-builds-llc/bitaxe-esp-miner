...
recheck-scoreboard-evidence-v2 *args:
    bazel run //tools/automation:recheck_scoreboard_evidence_v2 -- {{ args }}
...
stratum-v2-campaign-preflight *args:
    bazel run //tools/automation:stratum_v2_campaign_preflight -- {{ args }}

stratum-v2-runtime-admission *args:
    bazel run //tools/automation:stratum_v2_runtime_admission -- {{ args }}

stratum-v2-runtime-monitor-diagnostic *args:
    bazel run //tools/automation:stratum_v2_runtime_monitor_diagnostic -- {{ args }}
...
# Guarded serial Noise qualification; preflight requires published prerequisites.
stratum-v2-noise-serial action *args:
    bazel run //scripts:stratum_v2_noise_serial -- {{ quote(action) }} {{ args }}

stratum-v2-serial action *args:
    bazel run //scripts:stratum_v2_serial -- {{ quote(action) }} {{ args }}
