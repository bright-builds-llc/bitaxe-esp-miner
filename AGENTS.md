...
- Complete the migration only after fixed-USB ownership checks, 4 no-mining continuity/update cycles and the approved bounded live acceptance pass. Cleanup of the preexisting stuck detector is a precondition to hardware, not a reason to start another owner.
