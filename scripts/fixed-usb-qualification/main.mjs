...
export async function main(args, operations = {}) {
  ...
  const allowed = {
    "reset-origin-preflight": ["firmwareRoot", "gateRoot", "firmwareCommit", "gateCommit", "manifest", "privateRoot", "input", "originalCampaignRecord", "predecessorRoot", "previousReceipt", "qualificationSourceCommit", "supersedeUnstarted", "supersedePreparationReview", "supersedeJournalFailure"],
