...
export const CONTRACT_SHA256 = "0da417fc198a89042eb62902999ac822be5365a5f0333df8220f15afe3447a62";
...
export function parseStart(value) {
  ...
  requireValue(value.schema === "worker-noise-diagnostic-start-v1", "noise_start_schema");
