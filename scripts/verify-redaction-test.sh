...
printf '%s%s\n' 'pass' "word=${exception_secret}" >"${repo}/reviewed.txt"
printf 'RED-9001\tcredential-secret\treviewed.txt\tsynthetic reviewed test fixture\t2099-01-01\n' \
	>>"${repo}/scripts/redaction-exceptions.tsv"
git -C "$repo" add reviewed.txt scripts/redaction-exceptions.tsv
